...
Which pairs of population exhibit the largest FSt, and which the lowest? Plot a histogram, too. 
...
Visualise the pairwise matrix of FST. For this you should first convert the flattened list of pairs into a matrix, for example using the `xtabs` function in R, and then you can use `heatmap`.
