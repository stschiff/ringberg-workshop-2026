...
5. Let's visualise effective population size in space, for example using the `maps` package.
...
6. (Bonus) Plot heterozygosity as a function of the distance from Africa, for example from Addis Abeba in East Africa (Latitude ~ 39, Longitude ~9). You can compute the distance using the Haversine formula:
